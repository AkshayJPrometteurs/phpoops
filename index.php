...
<body>
    <div class="flex justify-center items-center h-screen w-full">
        <form action="AddUser.php" method="POST" class="w-96">
            <div class="mb-4 grid">
                <label>Find User with ID</label>
            ...
            <div class="mb-4 grid">
                <label>Mobile</label>
                <input type="text" name="mobile" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div> -->
            <div class="mb-4 grid">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Find</button>
            </div>
        </form>
    </div>
</body>
